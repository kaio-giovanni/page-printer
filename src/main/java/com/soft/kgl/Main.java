...
@Command(name = "MainCli", mixinStandardHelpOptions = true, version = "1.0", description = "Main command line class of project")
public class Main implements Callable<Integer> {

    @Option(names = { "-p", "--page" }, description = "Page name", required = true)
    private String page;
